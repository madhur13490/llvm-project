...
; Many independent factor-2 candidates share one block, base pointer and vector
; type, i.e. a single match bucket. Every consecutive pair in the bucket is
; combined into a wide load and lowered to ld2.
